              ...
              >
                ...
                >
                  <div>
                    <p>
                      Source Of News:{" "}
                      <b>{step?.author ? step.author : "Unknown"}</b>
                    </p>
                    <h3>{step?.title}</h3>
                  </div>
                  <Typography sx={{ fontSize: { sx: "12px", lg: "20px" } }}>
                    {" "}
                    {step?.content ??
                      "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laudantium obcaecati veniam soluta, repellendus explicabo fuga neque porro, perspiciatis architecto tempore iure consequuntur omnis, non a illo facilis in quo incidunt magni sint aut voluptatem. Sint inventore deserunt harum eligendi incidunt."}
                  </Typography>
